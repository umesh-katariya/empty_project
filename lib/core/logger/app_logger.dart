...
class AppLog {
  ...
  static const String _DEFAULT_TAG_PREFIX = "Oomph App";
  ...
  ///Print info logs
  static i(dynamic message, {String tag = _DEFAULT_TAG_PREFIX}) {
    _log(INFO, tag, message.toString());
  }

  ///Print debug logs
  static d(dynamic message, {String tag = _DEFAULT_TAG_PREFIX}) {
  ...
  ///Print error logs
  static e(dynamic message, {String tag = _DEFAULT_TAG_PREFIX}) {
  ...
  static prettyPrint(Map message, {String tag = _DEFAULT_TAG_PREFIX}) {
    _log(MAP, tag, encoder.convert(message));
  }
}
